Feature: Show serie details page, with its info and available capitles ordered by season
  ...
  Background: Existing serie "Mád Mënè" with 4 seasons and the capitles above
  Given an existing serie "Mád Mënè" with description "Business is business"
  And the existing capitles for the serie "Mád Mënè":
		| title       | season | order |
		| "title11"   | 1      | 1     |
		| "title12"   | 1      | 2     |
		| "title13"   | 1      | 3     |
		...
		| "title41"   | 4      | 1     |
		| "title42"   | 4      | 2     |
   When I go to the "Mád Mënè" serie page

  Scenario: See details/info about "Mád Mënè" in its page
    Then I should see "Mád Mënè" in the serie detail field "serie_title"
    And I should see "Weird stuff" in the serie detail field "serie_description"
    And I should see "Seasons: 4, capitles: 10"

  Scenario: See 'Mád Mënè' serie's capitles links grouped by season in independent containers
  ...
  Scenario: See the correct capitle titles for "Mád Mënè"'s capitles within each container
  ...
  Scenario: See the correct capitle links for "Mád Mënè"'s capitles within each container
